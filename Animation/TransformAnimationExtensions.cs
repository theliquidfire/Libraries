...
namespace TheLiquidFire.Animation
{
	public static class TransformAnimationExtensions
	{
		...
		public static Tweener ScaleToLocal(this Transform t, Vector3 scale)
		{
			return ScaleToLocal(t, scale, Tweener.DefaultDuration);
		}
		
		public static Tweener ScaleToLocal(this Transform t, Vector3 scale, float duration)
		{
			return ScaleToLocal(t, scale, duration, Tweener.DefaultEquation);
		}
		
		public static Tweener ScaleToLocal(this Transform t, Vector3 scale, float duration, Func<float, float, float, float> equation)
		{
